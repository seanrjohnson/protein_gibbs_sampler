...
if __name__ == "__main__":
    ...
    parser.add_argument("--alignment_size", default=sys.maxsize, help="Sample this many sequences from the input alignment before doing gibbs sampling, recommended values are 32-256. Default: the entire input alignment.")
